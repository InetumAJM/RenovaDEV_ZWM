...
** ERRO tabela nao pode vir preenchida
    ...
    ELSE.
      SELECT * FROM ZWM006 INTO CORRESPONDING FIELDS OF TABLE L_ZWM006
...
*        SORT L_ZWM006 BY NUM_ENTRADA ASCENDING.
  ...
  ELSEIF OPERACAO = '2'.
    ...
    IF NOT L_ZWM006[] IS INITIAL.
      ...
      MOVE-CORRESPONDING L_ZWM006 TO ZWM006.
      MODIFY ZWM006.
