...
REPORT  zwmrep0041 MESSAGE-ID zwmmsg001.
...
SELECT-OPTIONS s_sscc FOR vekp-exidv  OBLIGATORY.
PARAMETERS: p_print   LIKE pri_params-pdest OBLIGATORY,
            p_copies  like ITCPO-TDCOPIES OBLIGATORY DEFAULT 3,
