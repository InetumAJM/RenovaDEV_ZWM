...
*                                                                      *
************************************************************************
* Nome ABAP.: ZWMREP0053                                               *
* Nm.Cliente: RENOVA                                                   *
* Descrição.: Impressão da Nota de Entrega (Sapscript)                 *
* Criado por: Ricardo Lopes                                            *
* Criado em.: 04/05/2005                                               *
* Tipo PRG..: Report                                                   *
************************************************************************
* Modificado: Fernando Lopes 30/03/2007                                *
*             Novo Layout com número de Paletes                        *
************************************************************************
REPORT zwmrep0053_v2 LINE-COUNT 100.
...
* Cria TAB_GER
  LOOP AT lt_zwm028.
    ...
    IF lt_zwm028-remessa IS INITIAL.
      ...
      DATA aux_porta LIKE zwm002-porta.
      CLEAR aux_porta.

      CONCATENATE '0' lt_zwm028-porta+8(2) INTO aux_porta.

      CLEAR zwm002.
      SELECT SINGLE * FROM zwm002
             WHERE porta = aux_porta.
...
*             WHERE pulmao_1 = lt_zwm028-pulmao1.
    ...
    ELSE.
      ...
      IF lt_zwm028-servisan = 'X'.
        ...
        IF e_2step IS INITIAL.
          ...
          LOOP AT lt_zwm040.
            ...
            tab_ger-id_servisan = lt_zwm040-id_servisan.
            APPEND tab_ger.
            CLEAR tab_ger.
          ENDLOOP.
        ELSE.
      ...
      FROM t311a
        WHERE lgnum = lt_zwm028-lgnum
          AND refnr = lt_zwm028-refnr.
          LOOP AT lt_t311a.
            MOVE lt_t311a-refnr  TO tab_ger-refnr.
            MOVE lt_t311a-rbnum  TO tab_ger-remessa.
            MOVE lt_zwm028-ordem TO tab_ger-ordem.
            APPEND tab_ger.
            CLEAR tab_ger.
          ENDLOOP.
        ENDIF.
...
*****************************************************
  ...
  "criação de QRCODE para leitura optica de arquivamento da Nota de Entrega
  CONCATENATE 'https://www.myrenova.com/?DocType=ZSDONOTENT'  '&DocNumber=' z_numnota INTO Z_QRCODE.
