...
** Número do transporte associado à carga
    SELECT SINGLE N_TRANSPORTE FROM ZWM006_aux
                               INTO ZWM006_aux-N_TRANSPORTE
                               WHERE ARMAZEM     = ARMAZEM
                               AND   NUM_ENTRADA = TI_ZWM003-NUM_ENTRADA
.
    IF SY-SUBRC = 0.
...
** É uma DESCARGA
    ...
    CLEAR : ZWM006_aux-N_TRANSPORTE, VTTK, TI_ZWM003, VALOR, VTTP-VBELN.
