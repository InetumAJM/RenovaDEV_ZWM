...
REPORT zwmrep0054 NO STANDARD PAGE HEADING.
...
FORM build_hierarchy_header CHANGING
  ...
  p_hierarchy_header-heading = 'Grupo/Fornecimento'.
  p_hierarchy_header-tooltip =
                         'Hierarquia: Grupo/Fornecimento'.
...
FORM create_hierarchy.
  ...
  DELETE tab_out WHERE remessa EQ space.
...
* LIST HEADING LINE: TYPE H
  CLEAR ls_line.
  ls_line-typ  = 'H'.
  ls_line-info = 'Nota de Entrega'(t00).
...
*        END OF lt_zwm013.
  ...
  REFRESH: lr_destino, tab_ger, tab_pal, lt_ltap, lt_t311a.

  CLEAR: tab_pal, tab_ger, lt_ltap, lt_t311a.
...
* SORT tab_pal BY remessa sscc destino.
  ...
  FREE: lt_zwm028, lt_zwm026, lt_ltap.
