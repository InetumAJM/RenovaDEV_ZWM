...
*"----------------------------------------------------------------------
  DATA : ti_zwm003 LIKE zwm003_aux OCCURS 0 WITH HEADER LINE,
         ...
         ti_portas LIKE zwm003_aux OCCURS 0 WITH HEADER LINE.
...
** associada à mesma
      ...
      LOOP AT material_posicao WHERE NOT zona IS INITIAL.
        EXIT.
      ENDLOOP.
...
*-------------------------------------------------------Ins Mai2005
                ...
                ti_portas-matricula   = matricula.
                ti_portas-num_entrada = num_entrada.
                ti_portas-porta       = porta_d.
*                APPEND ti_portas. CLEAR ti_portas.
                COLLECT ti_portas. CLEAR ti_portas.
...
*         Achar uma porta de carga livre associáda ao pulmão
        ...
        IF sy-subrc = 0.
          ...
          LOOP AT l_portas_cargap.
            ...
            ELSEIF zwm028-pulmao1 = l_portas_cargap-pulmao9.

              l_portas_cargap-peso = 9.
              MODIFY l_portas_cargap INDEX sy-tabix.

            ELSEIF zwm028-pulmao1 = l_portas_cargap-pulmao10.

              l_portas_cargap-peso = 10.
              MODIFY l_portas_cargap INDEX sy-tabix.

            ELSEIF zwm028-pulmao1 = l_portas_cargap-pulmao11.

              l_portas_cargap-peso = 11.
              MODIFY l_portas_cargap INDEX sy-tabix.

            ELSEIF zwm028-pulmao1 = l_portas_cargap-pulmao12.

              l_portas_cargap-peso = 12.
              MODIFY l_portas_cargap INDEX sy-tabix.

            ELSEIF zwm028-pulmao1 = l_portas_cargap-pulmao13.

              l_portas_cargap-peso = 13.
              MODIFY l_portas_cargap INDEX sy-tabix.

            ELSEIF zwm028-pulmao1 = l_portas_cargap-pulmao14.

              l_portas_cargap-peso = 14.
              MODIFY l_portas_cargap INDEX sy-tabix.

            ELSEIF zwm028-pulmao1 = l_portas_cargap-pulmao15.

              l_portas_cargap-peso = 15.
              MODIFY l_portas_cargap INDEX sy-tabix.

            ELSEIF zwm028-pulmao1 = l_portas_cargap-pulmao16.

              l_portas_cargap-peso = 16.
              MODIFY l_portas_cargap INDEX sy-tabix.

            ELSEIF zwm028-pulmao1 = l_portas_cargap-pulmao17.

              l_portas_cargap-peso = 17.
              MODIFY l_portas_cargap INDEX sy-tabix.

            ELSEIF zwm028-pulmao1 = l_portas_cargap-pulmao18.

              l_portas_cargap-peso = 18.
              MODIFY l_portas_cargap INDEX sy-tabix.

            ELSEIF zwm028-pulmao1 = l_portas_cargap-pulmao19.

              l_portas_cargap-peso = 19.
              MODIFY l_portas_cargap INDEX sy-tabix.

            ELSEIF zwm028-pulmao1 = l_portas_cargap-pulmao20.

              l_portas_cargap-peso = 20.
              MODIFY l_portas_cargap INDEX sy-tabix.

            ELSEIF zwm028-pulmao1 = l_portas_cargap-pulmao21.

              l_portas_cargap-peso = 21.
              MODIFY l_portas_cargap INDEX sy-tabix.

            ELSEIF zwm028-pulmao1 = l_portas_cargap-pulmao22.

              l_portas_cargap-peso = 22.
              MODIFY l_portas_cargap INDEX sy-tabix.

            ELSEIF zwm028-pulmao1 = l_portas_cargap-pulmao23.

              l_portas_cargap-peso = 23.
              MODIFY l_portas_cargap INDEX sy-tabix.

            ELSEIF zwm028-pulmao1 = l_portas_cargap-pulmao24.

              l_portas_cargap-peso = 24.
              MODIFY l_portas_cargap INDEX sy-tabix.
            ENDIF.

            ti_portas-matricula   = matricula.
            ti_portas-num_entrada = num_entrada.
            ti_portas-porta       = l_portas_cargap-porta.
*            APPEND ti_portas. CLEAR ti_portas.
            COLLECT ti_portas. CLEAR ti_portas.
...
*            READ TABLE ti_portas WITH KEY porta = porta.
*            DELETE ti_portas INDEX sy-tabix.
*
*************            EXIT.
*          ENDIF.
        ENDIF.
  ...
  ELSE.
    CLEAR: porta, ti_portas[], ti_portas, t_portas, t_portas[].
