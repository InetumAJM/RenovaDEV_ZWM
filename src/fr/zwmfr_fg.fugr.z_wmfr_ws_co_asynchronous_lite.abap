FUNCTION z_wmfr_ws_co_asynchronous_lite.
*"----------------------------------------------------------------------
*"*"Interface local:
*"  IMPORTING
...
*"----------------------------------------------------------------------
  DATA ls_input   TYPE zefacec2_zwmfr_ws_asynchronou1.
  DATA ls_output  TYPE zefacec2_zwmfr_ws_asynchronous.

  DATA lt_items   TYPE zefacec2_zwmfr_sedidd_tab.

  DATA lo_proxy TYPE REF TO zwm_efa_co_host_receiver_soap.
...
**********************************************************************
  ...
  ls_input-zwmfr_ws_asynchronous_lite1-iidocty         = i_idocty.
  ls_input-zwmfr_ws_asynchronous_lite1-ilgnum          = i_lgnum.
  ls_input-zwmfr_ws_asynchronous_lite1-imestyp         = i_mestyp.
  ls_input-zwmfr_ws_asynchronous_lite1-it_edidd-item[] = lt_items[].

  TRY.
      lo_proxy->zwmfr_ws_asynchronous_lite( EXPORTING input   = ls_input
